...
for chunk in rag_chain.stream("What are the top 5 most significant changes in this release? (such as potential security updates, major API updates, or breaking changes)"):
